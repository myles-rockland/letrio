...
public:
	...
	void Rotate(const char grid[GRID_HEIGHT][GRID_WIDTH], bool clockwise = true); // Might need to return a bool, since rotation can fail in some cases. Rotation is around character 2. Use with currentPiece
